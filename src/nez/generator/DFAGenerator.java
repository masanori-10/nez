...
public class DFAGenerator extends ParserGenerator {
	...
	public void makeHeader(Grammar grammar) {
		this.file.write("// This file is generated by nez/src/nez/generator/SimpleCParserGenerator.java");
		...
		for (Production r : grammar.getProductionList()) {
			if (!r.getLocalName().startsWith("\"")) {
				this.file.writeIndent("int p" + r.getLocalName() + "(char* source, size_t* position);");
			}
		}
		this.file.writeNewLine();
	}
	...
	public void visitNonTerminal(NonTerminal p) {
		this.file.writeIndent("if(p" + p.getLocalName() + "(source, position))");
		this.openBlock();
		this.file.writeIndent("return 1;");
		this.closeBlock();
	}
